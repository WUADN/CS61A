...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    """
    # BEGIN PROBLEM 4
    currentScore = simple_update(num_rolls, player_score, opponent_score, dice)
    currentScore = sus_points(currentScore)
    return currentScore
    # END PROBLEM 4
